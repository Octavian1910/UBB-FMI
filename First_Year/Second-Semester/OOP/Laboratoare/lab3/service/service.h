...
/*
 Distruge service-ul si elibereaza memoria
 ...
 memoria ocupata de service este eliberata
*/
...
typedef int (*FunctieComparare)(Medicament*, Medicament*);
...
*/
Medicament** filtrareMedicamente(const ServiceFarmacie* s,int criteriu,const char* valoare,int* nr);
