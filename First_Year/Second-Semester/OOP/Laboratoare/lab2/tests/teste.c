...
void testSorteazaServiceMedicamente()
{
    ...
    int nr = 0;
    Medicament** lista = NULL;

    // 1. Test Sortare dupa Nume - Crescator (ordine = 1)
    lista = sortareMedicamente(s, comparaNume, 1, &nr);
    assert(nr == 4);
    ...
    // 2. Test Sortare dupa Nume - Descrescator (ordine = 0)
    lista = sortareMedicamente(s, comparaNume, 0, &nr);
    ...
    // 3. Test Sortare dupa Cantitate - Crescator (ordine = 1)
    lista = sortareMedicamente(s, comparaCantitate, 1, &nr);
    ...
    // 4. Test Sortare dupa Cantitate - Descrescator (ordine = 0)
    lista = sortareMedicamente(s, comparaCantitate, 0, &nr);
...
void testFiltreazaServiceMedicamente()
{
    ...
    char valoare[50] = "31";
    Medicament** lista = filtrareMedicamente(s,1,valoare,&nr);
    assert(nr == 2);
