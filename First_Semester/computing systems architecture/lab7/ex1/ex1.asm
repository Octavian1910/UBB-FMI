...
segment data use32 class=data
    ...
    rezultat dd 0
    format db "In sir sunt %d voccale "  , 0
...
start:
    ...
    loop_buffer:
        ...
        verif_carac :
            mov bl,[vocale + edi]
            cmp bl,0
            je iesire_verif_vocala ;daca a ajuns la 0 din vocale 
            
            cmp al,bl  ;verifica vocala  curenta din buffer cu vocala curenta  din sirul de vocale
            je contorizare_vocala
            
            ;daca nu a dat jmp la contorizare_vocala => urm vocala
            jmp final_sir_vocale
